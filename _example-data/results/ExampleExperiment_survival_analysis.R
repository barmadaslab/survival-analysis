...
workdir = "K:\\rmdev\\survival-analysis\\_example-data\\results"
fname = "ExampleExperiment_surv_data.csv"
expname = "ExampleExperiment"
groups = c('some-dna1', 'some-dna4', 'some-dna3', 'some-dna2')
